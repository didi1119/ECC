      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span style={{ color: "#6e7681" }}>/</span>
            <span className="text-xs" style={{ color: "#58a6ff" }}>多 Agent 協作</span>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <h1 className="text-3xl font-bold" style={{ color: "#e6edf3" }}>多 Agent 即時協作</h1>
                <span
              ...
              <p style={{ color: "#58a6ff" }}>前端、後端、基礎設施三個 Agent 同時出動，互不等待</p>
            </div>
          </div>

          <div className="rounded-xl p-5" style={{ backgroundColor: "rgba(88,166,255,0.06)", border: "1px solid rgba(88,166,255,0.2)" }}>
            <p className="text-sm font-semibold mb-1" style={{ color: "#58a6ff" }}>📖 情境故事</p>
            <p style={{ color: "#8b949e" }}>
              技術主管阿強要在這週完成整個電商平台的重構。
              他用 <code style={{ color: "#58a6ff" }}>/multi-plan</code> 啟動三個並行 Agent：
        ...
        <div className="mb-10">
          ...
          >
            <div className="text-center flex-1">
              <div className="text-4xl font-bold mb-1" style={{ color: "#f85149" }}>18h</div>
              <div className="text-xs" style={{ color: "#8b949e" }}>串行執行</div>
            </div>
            <div style={{ color: "#30363d", fontSize: "2rem" }}>→</div>
            <div className="text-center flex-1">
              <div className="text-4xl font-bold mb-1" style={{ color: "#3fb950" }}>8h</div>
              <div className="text-xs" style={{ color: "#8b949e" }}>並行執行</div>
            </div>
            <div style={{ color: "#30363d", fontSize: "2rem" }}>＝</div>
            <div className="text-center flex-1">
              <div className="text-4xl font-bold mb-1" style={{ color: "#ffa657" }}>55%</div>
              <div className="text-xs" style={{ color: "#8b949e" }}>節省時間</div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold" style={{ color: "#e6edf3" }}>🎬 多 Agent 即時協作視覺化</h2>
            <button
        ...
        {/* How it works */}
        <div className="mb-10">
          <h2 className="text-lg font-bold mb-4" style={{ color: "#e6edf3" }}>⚙️ 運作原理</h2>
          <div className="space-y-3">
            {[
              ...
              >
                ...
                <div>
                  <p className="font-semibold text-sm mb-0.5" style={{ color: "#e6edf3" }}>{item.title}</p>
        ...
        <div className="flex items-center justify-between pt-6" style={{ borderTop: "1px solid #30363d" }}>
          <Link href="/scenarios/expert/prd-pipeline" className="text-sm hover:underline" style={{ color: "#8b949e" }}>← PRD 流水線</Link>
          <Link
